...
public class FragmentCheckoutBindingImpl extends FragmentCheckoutBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        java.lang.String viewModelMenuItemsViewModelSideNameGetFormattedPrice = null;
        ...
        com.example.lunchtray.model.MenuItem viewModelMenuItemsViewModelAccompanimentName = null;
        ...
        com.example.lunchtray.model.MenuItem viewModelMenuItemsViewModelEntreeName = null;
        ...
        java.lang.String viewModelMenuItemsViewModelAccompanimentNameGetFormattedPrice = null;
        androidx.lifecycle.LiveData<java.lang.String> viewModelTotal = null;
        java.lang.String viewModelMenuItemsViewModelEntreeNameGetFormattedPrice = null;
        ...
        com.example.lunchtray.model.MenuItem viewModelMenuItemsViewModelSideName = null;
        ...
        if ((dirtyFlags & 0x1bfL) != 0) {
            ...
            if ((dirtyFlags & 0x195L) != 0) {
                ...
                if ((dirtyFlags & 0x181L) != 0) {
                        ...
                        if (viewModelMenuItems != null) {
                            // read viewModel.menuItems[viewModel.accompaniment.getValue().name]
                            viewModelMenuItemsViewModelAccompanimentName = viewModelMenuItems.get(viewModelAccompanimentName);
                        }


                        if (viewModelMenuItemsViewModelAccompanimentName != null) {
                            // read viewModel.menuItems[viewModel.accompaniment.getValue().name].getFormattedPrice()
                            viewModelMenuItemsViewModelAccompanimentNameGetFormattedPrice = viewModelMenuItemsViewModelAccompanimentName.getFormattedPrice();
                        }
                }
            }
            if ((dirtyFlags & 0x184L) != 0) {
                    ...
                    if (viewModelMenuItems != null) {
                        // read viewModel.menuItems[viewModel.entree.getValue().name]
                        viewModelMenuItemsViewModelEntreeName = viewModelMenuItems.get(viewModelEntreeName);
                    }


                    if (viewModelMenuItemsViewModelEntreeName != null) {
                        // read viewModel.menuItems[viewModel.entree.getValue().name].getFormattedPrice()
                        viewModelMenuItemsViewModelEntreeNameGetFormattedPrice = viewModelMenuItemsViewModelEntreeName.getFormattedPrice();
                    }
            }
            ...
            if ((dirtyFlags & 0x190L) != 0) {
                    ...
                    if (viewModelMenuItems != null) {
                        // read viewModel.menuItems[viewModel.side.getValue().name]
                        viewModelMenuItemsViewModelSideName = viewModelMenuItems.get(viewModelSideName);
                    }


                    if (viewModelMenuItemsViewModelSideName != null) {
                        // read viewModel.menuItems[viewModel.side.getValue().name].getFormattedPrice()
                        viewModelMenuItemsViewModelSideNameGetFormattedPrice = viewModelMenuItemsViewModelSideName.getFormattedPrice();
                    }
            }
        ...
        if ((dirtyFlags & 0x181L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.accompanimentPrice, viewModelMenuItemsViewModelAccompanimentNameGetFormattedPrice);
        ...
        if ((dirtyFlags & 0x184L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.entreePrice, viewModelMenuItemsViewModelEntreeNameGetFormattedPrice);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.entreeSelection, viewModelEntreeName);
        }
        if ((dirtyFlags & 0x190L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.sidePrice, viewModelMenuItemsViewModelSideNameGetFormattedPrice);
